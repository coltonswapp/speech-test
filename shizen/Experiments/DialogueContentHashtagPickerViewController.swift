//
//  DialogueContentHashtagPickerViewController.swift
//  shizen
//
//  Sheet of recommended hashtags for Dialogue Replay posts.
//  Select up to five, then copy them to the clipboard in tap order.
//

import UIKit

final class DialogueContentHashtagPickerViewController: UITableViewController {
