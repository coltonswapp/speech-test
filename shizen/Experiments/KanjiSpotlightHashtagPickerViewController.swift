//
//  KanjiSpotlightHashtagPickerViewController.swift
//  shizen
//
//  Sheet of recommended hashtags for Kanji Spotlight exports.
//  Select up to five, then copy them to the clipboard in tap order.
//

import UIKit

final class KanjiSpotlightHashtagPickerViewController: UITableViewController {
