//
//  RegisterLadderHashtagPickerViewController.swift
//  shizen
//
//  Sheet of recommended hashtags for register-ladder exports.
//  Select up to five, then copy them to the clipboard in tap order.
//

import UIKit

final class RegisterLadderHashtagPickerViewController: UITableViewController {
